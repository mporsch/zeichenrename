========================================================================
    ANWENDUNG: zeichenrename-Projektübersicht
========================================================================

Diese zeichenrename-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, aus denen Ihre zeichenrename-Anwendung besteht.

zeichenrename.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "zeichenrename.pch und eine 
